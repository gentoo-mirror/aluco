...
mmx qt4 quicktime sdl sox sse sse2 swfdec vorbis xine xml lua python ruby vdpau" # java perl php tcl mono
...
DEPEND="${RDEPEND}
	...
	python? ( ${SWIG_DEPEND} )
	ruby? ( ${SWIG_DEPEND} )"
#	luma-8bpp? ( || ( media-gfx/imagemagick
#			media-gfx/graphicsmagick[imagemagick] ) )
...
src_configure() {
	...
	#use vdpau && myconf="${myconf} --avformat-vdpau"
